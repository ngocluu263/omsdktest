...
print("======")
emailtest(idrac, "AA@gmail.com", "added")
emailtest(idrac, "axx@gmail.com", "added")
emailtest(idrac, "xxxx@gmail.com", "added")
emailtest(idrac, "xxxx@gmail.com", "deleted", action=2)
